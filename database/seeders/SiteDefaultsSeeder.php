...
class SiteDefaultsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $settings = [
            ...
            'home.character_diary_limit' => [5, true],
            'home.community_limit' => [10, true],
            'home.header_enabled' => [true, true],
            'home.heading.announcements' => ['サイト更新情報', true],
            'home.heading.diaries' => ['メンバー日記', true],
            'home.heading.community' => ['コミュニティの新着', true],
            'home.heading.feeds' => ['外部RSS', true],
            'home.sections' => [['announcements', 'diaries', 'community', 'feeds'], true],
